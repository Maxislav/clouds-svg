...
</div>`;function r(i,t){return Math.floor(Math.random()*(t-i+1))+i}function u(i,t,o=3){let e=0;for(let l=0;l<o;l++)e+=Math.random();const s=e/o;return Math.floor(s*(t-i+1))+i}class f{cloudsContainerList;childEls=[];options={element:"#app",density:1};cloudsAll=1;constructor(t={}){this.options={...this.options,...t},this.cloudsAll=this.options.density;const o=document.createElement("slot");o.innerHTML=a,this.cloudsContainerList=[o.querySelector("[\\#cloudsContainer1]"),o.querySelector("[\\#cloudsContainer2]"),o.querySelector("[\\#cloudsContainer3]")],typeof this.options.element=="string"?document.querySelector(this.options.element).appendChild(o):this.options.element.appendChild(o)}init(){for(;this.childEls.length;)this.childEls.pop().remove();return this.cloudsContainerList.forEach(t=>{this.cloudsDraw(t)}),this}update(t={}){return this.options={...this.options,...t},this.cloudsAll=this.options.density,this.init(),this}cloudsDraw(t){const o="http://www.w3.org/2000/svg";for(let e=0;e<50+100*this.cloudsAll/.5;e++){const s=document.createElementNS(o,"g");this.childEls.push(s),s.innerHTML=this.getCloudBlock(),t.appendChild(s)}}getCloudBlock(){const t=r(1,8),o=r(10,15),e=u(50-80*this.cloudsAll,50+70*this.cloudsAll),s=u(1,20),l=r(40,30),p=r(l-10*this.cloudsAll,l-20*this.cloudsAll),d=r(10,20),c=r(0,20);return`
